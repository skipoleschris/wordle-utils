...
import wordle.service.WordCandidates.Companion.combinations
import wordle.service.WordCandidates.Companion.exclusions
import wordle.service.WordCandidates.Companion.hasDuplicateLetter
...
class WordCandidatesTest {
    ...
    fun `should generate an acceptable list of word candidates`() {
        ...
        val candidates = WordCandidates().generate(
            Dictionary(allWords, allowedWords),
            DictionaryAnalyser().analyseDictionary(allowedWords),
            5,
            3,
            true
        )
