...
import wordle.service.DictionaryFilter.Companion.containsKnownLetters
import wordle.service.DictionaryFilter.Companion.containsMisLocatedLetters
import wordle.service.DictionaryFilter.Companion.doesNotContainMultipleExclusions
import wordle.service.DictionaryFilter.Companion.doesNotContainPureExclusions
...
class DictionaryFilterTest {
    ...
    fun `should load and filter dictionary for all words containing known letters`() {
        val dictionary = DictionaryFilter().againstPattern(
            Pattern("Si---", setOf('a')),
